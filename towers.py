...
async def towers(ctx, round_id):
    ...
    if round_length < 30:
        ...
        pfp = 'https://cdn.discordapp.com/attachments/1010945168159019088/1016137702472699924/Screenshot_2022-09-04_135821.png'
        list = [0x000000]
        color = random.choice(list)
        em = discord.Embed(color=color)
        em.set_thumbnail(url=pfp)
        em.set_footer(text="we dont take responsibility for your loses please get some help and seek medical guidance.")
